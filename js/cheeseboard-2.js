fetch('../js/productos.json')
    ...
    .then(data => {
        ...
        productos.forEach((tabla) => {
            if (tabla.nombre === "Cheese Board n°2") {
                //SELECCIONAMOS DE FORMA DINAMICA EL ELEMENTO DESDE EL HTML
                const cheeseboardContenido = document.querySelector(`#cheeseboard-2`);
                ...
                <div class="contenedor_carrito">
                    <div class="color-bg row  flex-wrap">
                        <div class="col-md-4 color-bg d-flex flex-column">
                            <div class="img">
                                <img class="sombras" src="../imagenes/Quesos2.jpg" alt="">
                            </div>
                            <div role="button">
                                <a href="../index.html">
                        ...
                        <div class="col-md-8 color-bg buy-div h-100">
                            ...
                            <div>
                                ...
                                <p class="description-text fw-bold font">
                                    4 clases de quesos: 3 clases de Quesos nacionales y 1 clase de queso de untar de receta casera. <br>
                                    3 clases de fiambres. <br>
